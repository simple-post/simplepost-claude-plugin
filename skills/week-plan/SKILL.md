...
5. After approval, draft each post. Use the `simplepost:platform-copywriter` sub-agent independently per platform where parallel drafting helps keep variants distinct.
